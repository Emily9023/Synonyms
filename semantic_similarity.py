...
def build_semantic_descriptors_from_files(filenames):
    ...
    [",", "-", "--", ":", ";"]'''
    '''
    print("this is filenbames", filenames)
    sentences = ""
    lines = []
...
#     #build_semantic_descriptors_from_files("semantic_file.txt")
#
#     print(cosine_similarity({"i": 3, "am": 3, "a": 2, "sick": 1, "spiteful": 1, "an": 1, "unattractive": 1}
# , {"i": 1, "believe": 1, "my": 1, "is": 1, "diseased": 1}
# ))
#
#    # cosine_similarity(vec1[1:], vec2[1:])
#
    #sentences = [["i", "am", "a", "sick", "man"],["i", "am", "a", "spiteful", "man"],["i", "am", "an", "unattractive", "man"],
    # ["i", "believe", "my", "liver", "is", "diseased"],["however", "i", "know", "nothing", "at", "all", "about", "my","disease", "and", "do","not", "know", "for", "certain", "what", "ails", "me"]]
    #
    # sem_descriptors = build_semantic_descriptors_from_files(["sample_case"])
    # print(sem_descriptors)
    # print(sem_descriptors["am"])
    # print(cosine_similarity(sem_descriptors["i"],sem_descriptors["know"]))
    #
    # print(most_similar_word("i", ["sick", "a", "am", "know", "man"], sem_descriptors, cosine_similarity))
